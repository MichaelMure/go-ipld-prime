...
func (Bool) LookupByString(string) (ipld.Node, error) {
	return mixins.Bool{"schema.Bool"}.LookupByString("")
}
func (Bool) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.Bool{"schema.Bool"}.LookupByNode(nil)
}
func (Bool) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Bool{"schema.Bool"}.LookupByIndex(0)
}
func (Bool) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.Bool{"schema.Bool"}.LookupBySegment(seg)
}
...
func (Bool) AsInt() (int, error) {
	return mixins.Bool{"schema.Bool"}.AsInt()
}
func (Bool) AsFloat() (float64, error) {
	return mixins.Bool{"schema.Bool"}.AsFloat()
}
func (Bool) AsString() (string, error) {
	return mixins.Bool{"schema.Bool"}.AsString()
}
func (Bool) AsBytes() ([]byte, error) {
	return mixins.Bool{"schema.Bool"}.AsBytes()
}
func (Bool) AsLink() (ipld.Link, error) {
	return mixins.Bool{"schema.Bool"}.AsLink()
}
...
func (_Bool__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.BoolAssembler{"schema.Bool"}.BeginMap(0)
}
func (_Bool__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.BoolAssembler{"schema.Bool"}.BeginList(0)
}
func (na *_Bool__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.BoolAssembler{"schema.Bool"}.AssignNull()
...
func (_Bool__Assembler) AssignInt(int) error {
	return mixins.BoolAssembler{"schema.Bool"}.AssignInt(0)
}
func (_Bool__Assembler) AssignFloat(float64) error {
	return mixins.BoolAssembler{"schema.Bool"}.AssignFloat(0)
}
func (_Bool__Assembler) AssignString(string) error {
	return mixins.BoolAssembler{"schema.Bool"}.AssignString("")
}
func (_Bool__Assembler) AssignBytes([]byte) error {
	return mixins.BoolAssembler{"schema.Bool"}.AssignBytes(nil)
}
func (_Bool__Assembler) AssignLink(ipld.Link) error {
	return mixins.BoolAssembler{"schema.Bool"}.AssignLink(nil)
}
