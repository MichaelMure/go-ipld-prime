...
func (Float) LookupByString(string) (ipld.Node, error) {
	return mixins.Float{"schema.Float"}.LookupByString("")
}
func (Float) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.Float{"schema.Float"}.LookupByNode(nil)
}
func (Float) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Float{"schema.Float"}.LookupByIndex(0)
}
func (Float) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.Float{"schema.Float"}.LookupBySegment(seg)
}
...
func (Float) AsBool() (bool, error) {
	return mixins.Float{"schema.Float"}.AsBool()
}
func (Float) AsInt() (int, error) {
	return mixins.Float{"schema.Float"}.AsInt()
}
func (n Float) AsFloat() (float64, error) {
	return n.x, nil
}
func (Float) AsString() (string, error) {
	return mixins.Float{"schema.Float"}.AsString()
}
func (Float) AsBytes() ([]byte, error) {
	return mixins.Float{"schema.Float"}.AsBytes()
}
func (Float) AsLink() (ipld.Link, error) {
	return mixins.Float{"schema.Float"}.AsLink()
}
...
func (_Float__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.FloatAssembler{"schema.Float"}.BeginMap(0)
}
func (_Float__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.FloatAssembler{"schema.Float"}.BeginList(0)
}
func (na *_Float__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.FloatAssembler{"schema.Float"}.AssignNull()
...
func (_Float__Assembler) AssignBool(bool) error {
	return mixins.FloatAssembler{"schema.Float"}.AssignBool(false)
}
func (_Float__Assembler) AssignInt(int) error {
	return mixins.FloatAssembler{"schema.Float"}.AssignInt(0)
}
...
func (_Float__Assembler) AssignString(string) error {
	return mixins.FloatAssembler{"schema.Float"}.AssignString("")
}
func (_Float__Assembler) AssignBytes([]byte) error {
	return mixins.FloatAssembler{"schema.Float"}.AssignBytes(nil)
}
func (_Float__Assembler) AssignLink(ipld.Link) error {
	return mixins.FloatAssembler{"schema.Float"}.AssignLink(nil)
}
