...
func (Int) LookupByString(string) (ipld.Node, error) {
	return mixins.Int{"schema.Int"}.LookupByString("")
}
func (Int) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.Int{"schema.Int"}.LookupByNode(nil)
}
func (Int) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Int{"schema.Int"}.LookupByIndex(0)
}
func (Int) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.Int{"schema.Int"}.LookupBySegment(seg)
}
...
func (Int) AsBool() (bool, error) {
	return mixins.Int{"schema.Int"}.AsBool()
}
func (n Int) AsInt() (int, error) {
	return n.x, nil
}
func (Int) AsFloat() (float64, error) {
	return mixins.Int{"schema.Int"}.AsFloat()
}
func (Int) AsString() (string, error) {
	return mixins.Int{"schema.Int"}.AsString()
}
func (Int) AsBytes() ([]byte, error) {
	return mixins.Int{"schema.Int"}.AsBytes()
}
func (Int) AsLink() (ipld.Link, error) {
	return mixins.Int{"schema.Int"}.AsLink()
}
...
func (_Int__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.IntAssembler{"schema.Int"}.BeginMap(0)
}
func (_Int__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.IntAssembler{"schema.Int"}.BeginList(0)
}
func (na *_Int__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.IntAssembler{"schema.Int"}.AssignNull()
...
func (_Int__Assembler) AssignBool(bool) error {
	return mixins.IntAssembler{"schema.Int"}.AssignBool(false)
}
...
func (_Int__Assembler) AssignFloat(float64) error {
	return mixins.IntAssembler{"schema.Int"}.AssignFloat(0)
}
func (_Int__Assembler) AssignString(string) error {
	return mixins.IntAssembler{"schema.Int"}.AssignString("")
}
func (_Int__Assembler) AssignBytes([]byte) error {
	return mixins.IntAssembler{"schema.Int"}.AssignBytes(nil)
}
func (_Int__Assembler) AssignLink(ipld.Link) error {
	return mixins.IntAssembler{"schema.Int"}.AssignLink(nil)
}
