...
func (n Map__FieldName__StructField) LookupByNode(k ipld.Node) (ipld.Node, error) {
	...
	if !ok {
		...
		// 'ipld.ErrInvalidKey{TypeName:"schema.Map__FieldName__StructField", Key:&_String{k}}' doesn't quite cut it: need room to explain the type, and it's not guaranteed k can be turned into a string at all
	}
	v, exists := n.m[*k2]
	if !exists {
...
func (Map__FieldName__StructField) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.LookupByIndex(0)
}
...
func (Map__FieldName__StructField) AsBool() (bool, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsBool()
}
func (Map__FieldName__StructField) AsInt() (int, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsInt()
}
func (Map__FieldName__StructField) AsFloat() (float64, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsFloat()
}
func (Map__FieldName__StructField) AsString() (string, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsString()
}
func (Map__FieldName__StructField) AsBytes() ([]byte, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsBytes()
}
func (Map__FieldName__StructField) AsLink() (ipld.Link, error) {
	return mixins.Map{"schema.Map__FieldName__StructField"}.AsLink()
}
...
func (_Map__FieldName__StructField__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.BeginList(0)
}
func (na *_Map__FieldName__StructField__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignNull()
	case schema.Maybe_Value, schema.Maybe_Null:
		panic("invalid state: cannot assign into assembler that's already finished")
	case midvalue:
...
func (_Map__FieldName__StructField__Assembler) AssignBool(bool) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignBool(false)
}
func (_Map__FieldName__StructField__Assembler) AssignInt(int) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignInt(0)
}
func (_Map__FieldName__StructField__Assembler) AssignFloat(float64) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignFloat(0)
}
func (_Map__FieldName__StructField__Assembler) AssignString(string) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignString("")
}
func (_Map__FieldName__StructField__Assembler) AssignBytes([]byte) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignBytes(nil)
}
func (_Map__FieldName__StructField__Assembler) AssignLink(ipld.Link) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField"}.AssignLink(nil)
}
func (na *_Map__FieldName__StructField__Assembler) AssignNode(v ipld.Node) error {
	...
	if v.ReprKind() != ipld.ReprKind_Map {
		return ipld.ErrWrongKind{TypeName: "schema.Map__FieldName__StructField", MethodName: "AssignNode", AppropriateKind: ipld.ReprKindSet_JustMap, ActualKind: v.ReprKind()}
	}
	itr := v.MapIterator()
	for !itr.Done() {
		k, v, err := itr.Next()
...
func (_Map__FieldName__StructField__Repr) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.LookupByIndex(0)
}
...
func (_Map__FieldName__StructField__Repr) AsBool() (bool, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsBool()
}
func (_Map__FieldName__StructField__Repr) AsInt() (int, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsInt()
}
func (_Map__FieldName__StructField__Repr) AsFloat() (float64, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsFloat()
}
func (_Map__FieldName__StructField__Repr) AsString() (string, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsString()
}
func (_Map__FieldName__StructField__Repr) AsBytes() ([]byte, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsBytes()
}
func (_Map__FieldName__StructField__Repr) AsLink() (ipld.Link, error) {
	return mixins.Map{"schema.Map__FieldName__StructField.Repr"}.AsLink()
}
...
func (_Map__FieldName__StructField__ReprAssembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.BeginList(0)
}
func (na *_Map__FieldName__StructField__ReprAssembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr.Repr"}.AssignNull()
	case schema.Maybe_Value, schema.Maybe_Null:
		panic("invalid state: cannot assign into assembler that's already finished")
	case midvalue:
		panic("invalid state: cannot assign null into an assembler that's already begun working on recursive structures!")
...
func (_Map__FieldName__StructField__ReprAssembler) AssignBool(bool) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignBool(false)
}
func (_Map__FieldName__StructField__ReprAssembler) AssignInt(int) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignInt(0)
}
func (_Map__FieldName__StructField__ReprAssembler) AssignFloat(float64) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignFloat(0)
}
func (_Map__FieldName__StructField__ReprAssembler) AssignString(string) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignString("")
}
func (_Map__FieldName__StructField__ReprAssembler) AssignBytes([]byte) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignBytes(nil)
}
func (_Map__FieldName__StructField__ReprAssembler) AssignLink(ipld.Link) error {
	return mixins.MapAssembler{"schema.Map__FieldName__StructField.Repr"}.AssignLink(nil)
}
func (na *_Map__FieldName__StructField__ReprAssembler) AssignNode(v ipld.Node) error {
	...
	if v.ReprKind() != ipld.ReprKind_Map {
		return ipld.ErrWrongKind{TypeName: "schema.Map__FieldName__StructField.Repr", MethodName: "AssignNode", AppropriateKind: ipld.ReprKindSet_JustMap, ActualKind: v.ReprKind()}
	}
	itr := v.MapIterator()
	for !itr.Done() {
		k, v, err := itr.Next()
