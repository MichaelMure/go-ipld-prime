...
func (String) LookupByString(string) (ipld.Node, error) {
	return mixins.String{"schema.String"}.LookupByString("")
}
func (String) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.String{"schema.String"}.LookupByNode(nil)
}
func (String) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.String{"schema.String"}.LookupByIndex(0)
}
func (String) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.String{"schema.String"}.LookupBySegment(seg)
}
...
func (String) AsBool() (bool, error) {
	return mixins.String{"schema.String"}.AsBool()
}
func (String) AsInt() (int, error) {
	return mixins.String{"schema.String"}.AsInt()
}
func (String) AsFloat() (float64, error) {
	return mixins.String{"schema.String"}.AsFloat()
}
func (n String) AsString() (string, error) {
	return n.x, nil
}
func (String) AsBytes() ([]byte, error) {
	return mixins.String{"schema.String"}.AsBytes()
}
func (String) AsLink() (ipld.Link, error) {
	return mixins.String{"schema.String"}.AsLink()
}
...
func (_String__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.StringAssembler{"schema.String"}.BeginMap(0)
}
func (_String__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.StringAssembler{"schema.String"}.BeginList(0)
}
func (na *_String__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.StringAssembler{"schema.String"}.AssignNull()
...
func (_String__Assembler) AssignBool(bool) error {
	return mixins.StringAssembler{"schema.String"}.AssignBool(false)
}
func (_String__Assembler) AssignInt(int) error {
	return mixins.StringAssembler{"schema.String"}.AssignInt(0)
}
func (_String__Assembler) AssignFloat(float64) error {
	return mixins.StringAssembler{"schema.String"}.AssignFloat(0)
}
...
func (_String__Assembler) AssignBytes([]byte) error {
	return mixins.StringAssembler{"schema.String"}.AssignBytes(nil)
}
func (_String__Assembler) AssignLink(ipld.Link) error {
	return mixins.StringAssembler{"schema.String"}.AssignLink(nil)
}
